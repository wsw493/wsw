		...
		<div className={styles.main}>
            ...
            <div className={styles.rigthCont}>
                ...
                <div className={styles.bt_bar}>
                    {functionCodesMap['CF_MANAGE_TENANT_ROLE_ADD']?<Button icon="file-add" onClick={showNewWindow}>新增</Button>:''}
                    {functionCodesMap['CF_MANAGE_TENANT_ROLE_DEL']?<Button icon="delete" onClick={bulkDelete}>删除</Button>:''}
                    {functionCodesMap['CF_MANAGE_TENANT_ROLE_UPDATE']?<Button icon="edit" onClick={showEditWindow}>修改</Button>:""}
                    {functionCodesMap['CF_MANAGE_TENANT_ROLE_VIEW']?<Button icon="eye-o" onClick={showViewWindow}>查看</Button>:''}
                </div>
