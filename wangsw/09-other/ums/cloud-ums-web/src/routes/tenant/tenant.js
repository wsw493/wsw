...
function Tenant({dispatch,tenant}) {
	const {tableData,tableLoading,pageSize,currentPageIndex,newItem,editItem,viewItem,tenantName,enabled,
        ...
        codeUnique,nameUnique,domainUnique,passwordFlag,sort,functionCodesMap,mapInfo,checkBoxStatus,radioStatus,arcgisInfo,mapType} = tenant;
    ...
    const newItemProps = {
        ...
        contentProps:{
            ...
            updateObj(obj){
                dispatch({type:"tenant/updateObj",payload:{...obj}});
            },
        }
    }
    const editItemProps = {
