    	...
    	<div className={style.main}>
    		...
    		<div className={style.rigthCont}>
    			...
    			<div className={style.bt_bar}>
    				{functionCodesMap['CF_MANAGE_SYSTEM_STAFF_ADD']?<Button icon="file-add" onClick={showNewWindow}>新增</Button>:''}
    				{functionCodesMap['CF_MANAGE_SYSTEM_STAFF_UPDATE']?<Button icon="edit" onClick={showEditWindow}>修改</Button>:''}
                    {functionCodesMap['CF_MANAGE_SYSTEM_STAFF_VIEW']?<Button icon="eye-o" onClick={showViewWindow}>查看</Button>:''}
