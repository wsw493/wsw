...
const EditItem = (props)=>{
    ...
    const {id,checkState,tenantId,code,name,workElementTypeId,shape,departmentId,departmentName,divisionId,divisionName,mapType,area,
            length,radius,color,paramsDone,workElementTypeList,mapDraw,isDraw,mapPoints,codeUnique,nameUnique,mapCenter,setCenter,
                   ...
                   <div className={styles.halfLayout}>
                        ...
                        <Button onClick={()=>{
                            if(shape == ""){
                                  ...
                                  const mapDrawConfig = {
                                        geometryType: shape=='line'?'polyline':shape,
                                        parameter: {},
                                        data: {id: 'workE'}
                                  };
                                  dispatch({type:'workElement/drawWorkE',payload:{mapDrawConfig:mapDrawConfig}});
                            }
                ...
                <div className={styles.formRow}>
                    <div className={styles.halfLayout}>
                        ...
                        <div className={styles.treeSelect}>
                            ...
                            />*/}
                            <TreeSelect
                                treeData={divisionTreeData}
                                treeDefaultExpandAll
                                dropdownStyle={{ maxHeight: 400, overflow: 'auto' }}
                                style={{width: "300px"}}
                                onChange={(value)=>{
                                   updateItem({divisionId:value});
                                }}
                                value={divisionId}
                            />
                        </div>
