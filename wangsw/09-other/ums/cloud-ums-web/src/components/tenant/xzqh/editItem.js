...
const EditItem = (props)=>{
    ...
    const {id,checkState,parentName,parentId,name,abbr,mapType,commonCode,level,levelText,lonLatStr,orderIndex,latitude,editGraphicId,
            latitudeDone,longitude,longitudeDone,startTime,checkOrder,showMap,mapPoints,centerPoint,mapLines,isDraw,isClearAll,mapDraw,
        mapPolygons,lngLats,accountUnique,mapId} = contentProps;
    ...
    function setRange(){
        updateState({modal2Visible: true});
    }
    return (
        <VtxModal {...modalProps}>
            <div className={styles.formWrapper}>
                ...
                <div className={styles.formRow}>
                    <div className={styles.halfLayout}>
                        ...
                        <Button type="primary" onClick={setRange}>设置范围</Button>
                    </div>
                </div>
                {
                    showMap?
