...
export async function getLoginInfo(param){
    return request('/casServer/user',{
        body: param
    })
}

//获取租户信息
export async function convertToAddress(param){
    return request('/vortexapi/rest/lbs/geoconvert/v2' + sa,{
        body: param,
        method: 'get'
    })
}

export async function getParamsDone(param){
    return request('cloud/management/workElement/getParamsDone',{
        body: param,
        method: 'get'
    })
}
...
/********************系统角色组*********************/
//角色组列表数据
export async function getSystemRoleGroupTable(param){
    return request('/cloud/management/systemrolegroup/pageList' + sa,{
        body: param
    })
}
//角色组树
export async function getSystemRoleGroupTree(param){
    return request('/cloud/management/systemrolegroup/loadTree' + sa,{
        body: param
    })
}
//新增角色组
export async function saveSystemRoleGroup(param){
    return request('/cloud/management/systemrolegroup/save' + sa,{
        body: param
    })
}
//角色组code,name唯一性校验
export async function validateSystemRoleGroup(param){
    return request('/cloud/management/systemrolegroup/checkForm/'+ param.key + sa,{
        body: param.param
    })
}

//修改角色组
export async function updateSystemRoleGroup(param){
    return request('/cloud/management/systemrolegroup/update' + sa,{
        body: param
    })
}
//删除角色组
export async function deleteSystemRoleGroup(param){
    return request('/cloud/management/systemrolegroup/delete/'+ param + sa,{
        body: {}
    })
}
//删除角色组(批量)
export async function deletesSystemRoleGroup(param){
    return request('/cloud/management/systemrolegroup/deletes' + sa,{
        body: param,
        contentType: ContentType.JSON
    })
}
...
/********************系统角色*********************/
//角色列表数据
export async function getSystemRoleTable(param){
    return request('/cloud/management/systemrole/pageList' + sa,{
        body: param
    })
}

//新增角色
export async function saveSystemRole(param){
    return request('/cloud/management/systemrole/save' + sa,{
        body: param
    })
}
//角色code,name唯一性校验
export async function validateSystemRole(param){
    return request('/cloud/management/systemrole/checkForm/'+ param.key + sa,{
        body: param.param
    })
}

//修改角色
export async function updateSystemRole(param){
    return request('/cloud/management/systemrole/update' + sa,{
        body: param
    })
}

//删除角色(批量)
export async function deletesSystemRole(param){
    return request('/cloud/management/systemrole/deletes' + sa,{
        body: param,
        contentType: ContentType.JSON
    })
}
//角色详情by Id
export async function getSystemRoleDtoById(param){
    return request('/cloud/management/systemrole/loadById' + sa,{
        body: param
    })
}
//角色功能关系数据
export async function loadMenuFunctionTree(param){
    return request('/cloud/management/systemrole/loadMenuFunctionTree',{
        body: param
    })
}