    	 	...
    	 	<div className={styles.formWrapper}>
                ...
                <div className={styles.formRow}>
                    <div className={styles.halfLayout}>
                        ...
                        {
                            baseData.STAFF_MARITAL_STATUS.map((ele)=>{
                                return <Option value={ele.value}>{ele.text}</Option>
                            })
                        }
                        </StateSelect>
                    ...
                    <div className={styles.halfLayout}>
                        ...
                        {
                            baseData.STAFF_POLITICAL_STATUS.map((ele)=>{
                                return <Option value={ele.value}>{ele.text}</Option>
                            })
                        }
                        </StateSelect>
                ...
                <div className={styles.formRow}>
                    <div className={styles.halfLayout}>
                        ...
                        {
                            baseData.STAFF_WORK_TYPE.map((ele)=>{
                                return <Option value={ele.value}>{ele.text}</Option>
                            })
                        }
                        </StateSelect>
                ...
                <div className={styles.formRow}>
                    ...
                    <div className={styles.halfLayout}>
                        ...
                        {
                            baseData.STAFF_EDUCATION.map((ele)=>{
                                return <Option value={ele.value}>{ele.text}</Option>
                            })
                        }
                        </StateSelect>
                ...
                <div className={styles.formRow}>
                	<div className={styles.halfLayout}>
                       ...
                       <StateSelect onChange={(value,label)=>{
                        ...
                        <Option value=''>无</Option>
                        {
                            baseData.STAFF_AUTHORIZE.map((ele)=>{
                                return <Option value={ele.value}>{ele.text}</Option>
                            })
                        }
                        </StateSelect>
                ...
                <div className={styles.formRow}>
                	<div className={styles.halfLayout}>
                       ...
                       <StateSelect onChange={(value,label)=>{
                        ...
                        {
                            baseData.STAFF_POSITION.map((ele)=>{
                                return <Option value={ele.value}>{ele.text}</Option>
                            })
                        }
                        </StateSelect>
                ...
                <div className={styles.formRow}>
                    ...
                    <div className={styles.halfLayout}>
                        ...
                        <Option value=''>无</Option>
                        {
                            baseData.STAFF_SOCIAL_SECURITY_CASE.map((ele)=>{
                                return <Option value={ele.value}>{ele.text}</Option>
                            })
                        }
                        </StateSelect>
