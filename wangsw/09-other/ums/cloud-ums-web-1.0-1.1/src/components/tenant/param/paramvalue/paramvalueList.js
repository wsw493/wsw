	...
	return (
		<div>
			<div className={styles.button}>
				{functionCodesMap['CF_MANAGE_TENANT_PARAM_ADD']?<Button icon="file-add" className='primary' onClick={paramValueAdd}>新增</Button>:''}
				{functionCodesMap['CF_MANAGE_TENANT_PARAM_BAT_DEL']?<Button icon="delete" className='delete' onClick={deleteItems}>删除</Button>:''}
			</div>
