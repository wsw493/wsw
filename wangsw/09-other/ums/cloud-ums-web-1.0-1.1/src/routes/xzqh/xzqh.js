    			...
    			<div className={styles.leftTree}>
	             ...
	             <div className={styles.rigthCont}>
	             	<div className={styles.bt_bar}>
						{functionCodesMap['CF_MANAGE_XZQH_ADD']?<Button icon="file-add" className='primary' onClick={showNewWindow}>新增</Button>:''}
						{functionCodesMap['CF_MANAGE_XZQH_DEL']?<Button icon="delete" className='delete' onClick={deleteItems}>删除</Button>:''}
