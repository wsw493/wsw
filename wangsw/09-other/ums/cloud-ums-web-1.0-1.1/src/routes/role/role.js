		...
		<div className={styles.main}>
            ...
            <div className={styles.rigthCont}>
                ...
                <div className={styles.bt_bar}>
                    {functionCodesMap['CF_MANAGE_ROLE_ADD']?<Button icon="file-add" className='primary' onClick={showNewWindow}>新增</Button>:''}
                    {functionCodesMap['CF_MANAGE_ROLE_DEL']?<Button icon="delete" className='delete' onClick={bulkDelete}>删除</Button>:''}
                    {functionCodesMap['CF_MANAGE_ROLE_UPDATE']?<Button icon="form" className="primary" onClick={showEditWindow}>修改</Button>:""}
                    {functionCodesMap['CF_MANAGE_ROLE_VIEW']?<Button icon="file-text" className="view" onClick={showViewWindow}>查看</Button>:''}
                </div>
