	...
	return (
		<div className={style.main}>
			...
			<div className={style.bt_bar}>
				<Button className={style.addBtn} icon="file-add" className='primary' onClick={showNewWindow}>新增</Button>
				<Button className={style.deleteBtn} icon="delete" className='delete' type="Button" onClick={deleteItem}>删除</Button>
			</div>
