		...
		<div className={styles.main}>
            ...
            <div className={styles.rigthCont}>
                ...
                <div className={styles.bt_bar}>
                    {functionCodesMap['CF_MANAGE_MENU_ADD']?<Button icon="file-add" className='primary' onClick={showNewWindow}>新增</Button>:''}
                    {functionCodesMap['CF_MANAGE_MENU_DEL']?<Button icon="delete" className='delete' onClick={bulkDelete}>删除</Button>:''}
                </div>
