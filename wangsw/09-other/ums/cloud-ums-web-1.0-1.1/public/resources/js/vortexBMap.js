...
VortexBMap.prototype = {
	...
	*/
	...
	//补点
	// additionalPoint(oldPoint,newPoint,callback){
	// 	var myP1 = new BMap.Point(oldPoint[0],oldPoint[1]);    //起点
 //        var driving = new BMap.DrivingRoute(myP1);
 //        var myP2 = new BMap.Point(newPoint[0],newPoint[1]);
 //        driving.search(myP1, myP2);
 //        var timeSearch = setInterval(function(){
 //        	driving.search(myP1, myP2);
 //        },5000);
 //        driving.setSearchCompleteCallback(function(){
 //        	if(timeSearch)clearInterval(timeSearch);
...
// eval(getArg(path,'callback'))();

// function getArg (l,key) {
