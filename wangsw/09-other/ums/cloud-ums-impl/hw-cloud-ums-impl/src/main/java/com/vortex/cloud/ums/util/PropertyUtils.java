...
public class PropertyUtils {
	...
	public static final String PROPERTIES_CUSTOM = "custom.properties";
	...
	public static String getPropertyByFileAndKey(String fileName, String propertyName) {
		if (StringUtils.isBlank(propertyName) || StringUtils.isBlank(fileName)) {
			return null;
		}
		return PropertiesHelper.getInstance(fileName).getProperty(fileName, propertyName);
	}
}