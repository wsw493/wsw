package com.vortex.cloud.cas.server.provider.request;
...
public class CustomOAuth2RequestFactory implements OAuth2RequestFactory {
    ...
    public TokenRequest createTokenRequest(Map<String, String> requestParameters, ClientDetails authenticatedClient) {
        ...
        BaseClientDetails baseClientDetails = (BaseClientDetails) authenticatedClient;
        requestParameters.put("appAuthServiceUrl", (String) baseClientDetails.getAdditionalInformation().get
                ("appAuthServiceUrl"));
        requestParameters.put("inside", (String) baseClientDetails.getAdditionalInformation().get
                ("inside"));
